...
[TestClass]
public class MasterpieceDyeTests
{
    ...
    [TestMethod]
    public void Print_ContainsDyedText()
    {
        var props = new List<Property>
        {
            ...
            new() { Name = "item_type", Value = "cloth" }
        };
        var evt = new MasterpieceDye(props, _mockWorld.Object);
        var result = evt.Print(link: true);
        Assert.IsTrue(result.Contains("dyed"));
    }
}
