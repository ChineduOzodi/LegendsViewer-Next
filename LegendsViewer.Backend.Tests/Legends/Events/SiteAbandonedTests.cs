...
[TestClass]
public class SiteAbandonedTests
{
    ...
    public void Constructor_WithValidProperties_ParsesCorrectly()
    {
        ...
        // Act
        var evt = new SiteAbandoned(properties, _mockWorld.Object);
    ...
    [TestMethod]
    public void Print_WithLink_ReturnsAbandonedString()
    {
        // Arrange
        var properties = new List<Property>
        {
        ...
        Assert.IsTrue(result.Contains("Old Settlement"));
    }
}
