...
public class PersecutionTests
{
    ...
    public void Setup()
    {
        ...
        _target = new Entity([], _mockWorld.Object) { Id = 1, Name = "Temple", Icon = "temple" };
    ...
    public void Constructor_WithValidProperties_ParsesCorrectly()
    {
        ...
        var evt = new Persecution(props, _mockWorld.Object);
    ...
    public void Constructor_SetsDefaultName()
    {
        ...
        Assert.IsTrue(evt.Name.Contains("persecution"));
    }
    ...
    public void ToLink_WithLink_ReturnsHtml()
    {
        ...
        Assert.IsTrue(result.Contains("persecution") || result.Contains("the"));
    }
    ...
    public void ToString_ReturnsFormattedString()
    {
        ...
        Assert.IsTrue(result.Contains("persecution"));
    }
}
