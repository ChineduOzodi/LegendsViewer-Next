...
[TestClass]
public class HfDestroyedSiteTests
{
    ...
    public void Constructor_WithValidProperties_ParsesCorrectly()
    {
        ...
        // Act
        var hfDestroyedSite = new HfDestroyedSite(properties, _mockWorld.Object);

        // Assert
        Assert.AreEqual(_attacker, hfDestroyedSite.Attacker);
        Assert.AreEqual(_defenderCiv, hfDestroyedSite.DefenderCiv);
        Assert.AreEqual(_siteCiv, hfDestroyedSite.SiteCiv);
        Assert.AreEqual(_site, hfDestroyedSite.Site);
    }
    ...
    public void Print_WithLinkTrue_ReturnsFormattedString()
    {
        ...
        // Act
        var result = hfDestroyedSite.Print(link: true);

        // Assert
        Assert.IsTrue(result.Contains("Destroyer"));
        Assert.IsTrue(result.Contains("routed"));
