...
[TestClass]
public class AgreementMadeTests
{
    ...
    public void Constructor_WithValidProperties_ParsesCorrectly()
    {
        ...
        // Act
        var agreement = new AgreementMade(properties, _mockWorld.Object);
    ...
    [TestMethod]
    public void Constructor_WithTreeQuotaTopic_ParsesCorrectly()
    {
        // Arrange
        var properties = new List<Property>
        {
    ...
    [TestMethod]
    public void Constructor_SameSourceAndDestination_OnlyAddsToSource()
    {
        // Arrange - same ID for source and destination
        var properties = new List<Property>
        {
            new Property { Name = "source", Value = "1" },
            new Property { Name = "destination", Value = "1" }
        };
        var initialEventCount = _source.Events.Count;
    ...
    public void Print_TreeQuota_ReturnsCorrectFormat()
    {
        ...
        Assert.IsTrue(result.Contains("was accepted"));
    }
