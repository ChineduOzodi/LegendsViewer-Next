...
public class RaidTests
{
    ...
    public void Setup()
    {
        ...
        _attacker = new Entity([], _mockWorld.Object) { Id = 1, Name = "Bandits", Icon = "bandits" };
        _defender = new Entity([], _mockWorld.Object) { Id = 2, Name = "Village", Icon = "civilization" };
    ...
    public void Constructor_WithValidProperties_ParsesCorrectly()
    {
        ...
        var evt = new Raid(props, _mockWorld.Object);
    ...
    public void Constructor_SetsDefaultName()
    {
        ...
        Assert.IsTrue(evt.Name.Contains("raid"));
    }
    ...
    public void ToLink_WithLink_ReturnsHtml()
    {
        ...
        Assert.IsTrue(result.Contains("raid") || result.Contains("the"));
    }
    ...
    public void ToString_ReturnsFormattedString()
    {
        ...
        Assert.IsTrue(result.Contains("raid"));
    }
}
