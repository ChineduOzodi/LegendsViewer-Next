...
[TestClass]
public class MasterpieceArchDesignTests
{
    ...
    [TestMethod]
    public void Constructor_WithValidProperties_SetsProcessToDesigned()
    {
        // Arrange
        ...
        // Act
        var masterpiece = new MasterpieceArchDesign(properties, _mockWorld.Object);
    ...
    public void Print_WithLink_ReturnsFormattedString()
    {
        ...
        // Assert
        Assert.IsTrue(result.Contains("Master Designer"));
        Assert.IsTrue(result.Contains("designed"));
    ...
    public void Print_WithSubtype_UsesSubtype()
    {
        ...
        var properties = new List<Property>
        {
            ...
            new Property { Name = "site_id", Value = "1" },
            new Property { Name = "building_type", Value = "tower" },
            new Property { Name = "building_subtype", Value = "library" }
        };
        var masterpiece = new MasterpieceArchDesign(properties, _mockWorld.Object);
        ...
        // Assert
        Assert.IsTrue(result.Contains("masterful library"));
    }
}
