...
[TestClass]
public class SiteSurrenderedTests
{
    ...
    public void Constructor_WithValidProperties_ParsesCorrectly()
    {
        ...
        // Act
        var evt = new SiteSurrendered(properties, _mockWorld.Object);
    ...
    [TestMethod]
    public void Constructor_WhenSiteEntityEqualsDefender_SkipsSiteEntityEvent()
    {
        // Arrange - SiteEntity = Defender
        var properties = new List<Property>
        {
            new Property { Name = "attacker_civ_id", Value = "1" },
            new Property { Name = "defender_civ_id", Value = "2" },
        ...
        // Assert - should not throw (doesn't add duplicate event)
        Assert.IsNotNull(evt);
    }

    [TestMethod]
    public void Print_WithLink_ReturnsSurrenderedString()
    {
        // Arrange
        var properties = new List<Property>
        {
        ...
        // Assert
        Assert.IsTrue(result.Contains("surrendered"));
        Assert.IsTrue(result.Contains("Fortress"));
        Assert.IsTrue(result.Contains("Attacking Kingdom"));
    }
}
