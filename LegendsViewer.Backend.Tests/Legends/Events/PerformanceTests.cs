...
public class PerformanceTests
{
    ...
    [TestMethod]
    public void Constructor_WithValidProperties_SetsOccasionTypeToPerformance()
    {
        // Arrange
        ...
        // Act
        var evt = new Performance(properties, _mockWorld.Object);

        // Assert
        Assert.IsNotNull(evt);
        Assert.AreEqual(LegendsViewer.Backend.Legends.Enums.OccasionType.Performance, evt.OccasionType);
    }
