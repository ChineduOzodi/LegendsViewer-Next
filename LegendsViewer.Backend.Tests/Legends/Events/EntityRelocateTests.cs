...
[TestClass]
public class EntityRelocateTests
{
    ...
    public void Constructor_WithValidProperties_ParsesCorrectly()
    {
        var properties = new List<Property>
        {
            ...
            new Property { Name = "action", Value = "entity_relocate" }
        };

        var evt = new EntityRelocate(properties, _mockWorld.Object);

        Assert.IsNotNull(evt);
        Assert.AreEqual(ActionsForEntities.Relocate, evt.Action);
    }
    ...
    public void Print_WithLink_ReturnsFormattedString()
    {
        ...
        Assert.IsTrue(result.Contains("moved to"));
    }
}
